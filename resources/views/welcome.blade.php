...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('layouts/css/bootstrap-icons.css') }}" rel="stylesheet">

        <link href="{{ asset('layouts/css/templatemo-tiya-golf-club.css') }}" rel="stylesheet">
...
-->
    ...
    <body>
        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="index.html">
                        <img src="{{ asset('layouts/images/logo.png')}}" class="navbar-brand-image img-fluid" alt="Tiya Golf Club">
         ...
         <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">                
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <!-- FORM LOGIN -->
                <form class="custom-form member-login-form"
                    method="POST"
                    action="{{ route('login') }}">
                    @csrf
                ...
                <div class="mt-auto mb-5">
                    <p>
                        ...
                        <a href="tel:0100200340" class="contact-link">
                            010-020-0340
                        </a>
                    </p>
                </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#3D405B" fill-opacity="1"
                    d="M0,224L34.3,192C68.6,160,137,96,206,90.7C274.3,85,343,139,411,144C480,149,549,107,617,122.7C685.7,139,754,213,823,240C891.4,267,960,245,1029,224C1097.1,203,1166,181,1234,160C1302.9,139,1371,117,1406,106.7L1440,96L1440,320Z">
                </path>
            </svg>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="{{ asset('layouts/images/members/portrait-young-handsome-businessman-wearing-suit-standing-with-crossed-arms-with-isolated-studio-white-background.jpg')}}" class="member-block-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="{{ asset('layouts/images/members/successful-asian-lady-boss-red-blazer-holding-clipboard-with-documens-pen-working-looking-happy-white-background.jpg')}}" class="member-block-image img-fluid" alt="">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="{{ asset('layouts/images/professional-golf-player.jpg')}}" class="custom-block-image img-fluid" alt="">
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="{{ asset('layouts/images/girl-taking-selfie-with-friends-golf-field.jpg')}}" class="custom-block-image img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="contact-info mt-5">
                                ...
                                <img src="{{ asset('layouts/images/WorldMap.svg')}}" class="img-fluid" alt="">
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 me-auto mb-5 mb-lg-0">
                        <a class="navbar-brand d-flex align-items-center" href="index.html">
                            <img src="{{ asset('layouts/images/logo.png') }}" class="navbar-brand-image img-fluid" alt="">
                            <span class="navbar-brand-text">
                                Tiya
                                <small>Golf Club</small>
                            </span>
        ...
        <script src="{{ asset('layouts/js/jquery.sticky.js') }}"></script>
        <script src="{{ asset('layouts/js/click-scroll.js') }}"></script>
        <script src="{{ asset('layouts/js/animated-headline.js') }}"></script>
        <script src="{{ asset('layouts/js/modernizr.js') }}"></script>
